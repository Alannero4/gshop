<template>
    ...
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" v-for="(item,index) in info.supports" :key="index" :class="suporrtClass[item.type]">
...
export default ({
    data(){
        return{
            suporrtClass:['activity-red','activity-orange','activity-green']
        }
    },
    computed:{
        ...mapState(['info'])
