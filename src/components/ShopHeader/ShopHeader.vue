<template>
    ...
    <div class="shop-content" @click="tooglleShopShow">
      ...
      <div class="header-content">
        ...
        <p class="shop-notice">{{info.distance}}}</p>
      </div>
    </div>
    <!--当异步请求时，info显示初始值，三级表达式会报错，因为info的supports为undefined，再往下会报错，要先用v-if隐藏掉-->
    <!--二级表达式不会报错，因为顶多会是undefined，而三级是在二级的基础上再往下找，二级是undefined了，三级肯定会报错-->
    <div class="shop-header-discounts" v-if="info.supports" @click="tooglleSupportShow">
    ...
    <transition name="fade">
      ...
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="tooglleShopShow">
    ...
    <div class="activity-sheet" v-show="supportsShow">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="tooglleSupportShow"></span>
        </div>
      </div>
